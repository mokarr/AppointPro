...
export default function UserLandingPage() {
    ...
    const features = [
        {
            icon: Search,
            title: getString(getTranslation('user.features.feature1.title')),
            description: getString(getTranslation('user.features.feature1.description'))
        },
        {
            icon: Clock,
            title: getString(getTranslation('user.features.feature2.title')),
            description: getString(getTranslation('user.features.feature2.description'))
        },
        {
            icon: Star,
            title: getString(getTranslation('user.features.feature3.title')),
            description: getString(getTranslation('user.features.feature3.description'))
        }
    ];

    // Ensure benefits is always an array with proper type checking
    const benefitsFromTranslation = getTranslation('user.benefits.items');
