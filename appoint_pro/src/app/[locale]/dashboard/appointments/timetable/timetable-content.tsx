...
import AppointmentForm, { AppointmentFormValues } from '@/app/[locale]/dashboard/appointments/timetable/appointment-form';
...
export default function TimeTableContent({ _user, _organization, _locations }: TimeTableContentProps) {
    ...
    return (
        <DashboardLayout>
            <DashboardHeader
                heading={t('timetable')}
                description={t('header.timetable.description')}
                action={
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                    <div className="mb-6 flex flex-col md:flex-row gap-4">
                        ...
                        <div className="w-full md:w-1/3">
                            ...
                            >
                                <SelectTrigger>
                                    <SelectValue placeholder={t('select.facility')} />
                                </SelectTrigger>
                                <SelectContent>
