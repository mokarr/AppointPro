...
export default function AppointmentDetails({
    ...
    return (
        <DashboardLayout>
            <DashboardHeader
                heading={getTranslation("common.appointmentDetails")}
                description={getTranslation("common.header.appointmentDetails.description")}
                action={
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Card className="col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>
                                {getTranslation("common.appointmentDetails")}
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            ...
                            {_appointment.notes && (
                                <div className="flex items-start border-t pt-4 mt-4">
                                    ...
                                    <div>
                                        <p className="font-medium">{getTranslation("common.notes")}</p>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>{getTranslation("common.customerInformation")}</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="flex items-center">
                        ...
                        <CardFooter className="border-t pt-4">
                            <div className="w-full text-sm text-gray-500">
                                <div className="flex justify-between">
                                    <span>{getTranslation("common.created")}</span>
                                    <span>{format(new Date(_appointment.createdAt), "PPP")}</span>
                                </div>
                                <div className="flex justify-between mt-1">
                                    <span>{getTranslation("common.updated")}</span>
            ...
            <Dialog open={isEditing} onOpenChange={setIsEditing}>
                <DialogContent className="sm:max-w-[600px]">
                    <DialogHeader>
                        <DialogTitle>{getTranslation("common.editAppointment")}</DialogTitle>
                        <DialogDescription>
                            {getTranslation("common.editAppointmentDescription")}
                        </DialogDescription>
                    </DialogHeader>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit as any)} className="space-y-4">
                            ...
                            <DialogFooter>
                                ...
                                <Button type="submit" disabled={isLoading}>
                                    {isLoading ? getTranslation("common.saving") : getTranslation("common.save")}
                                </Button>
                            </DialogFooter>
                        </form>
                    </Form>
            ...
            <Dialog open={isDeleting} onOpenChange={setIsDeleting}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>{getTranslation("common.confirmDelete")}</DialogTitle>
                        <DialogDescription>
                            {getTranslation("common.confirmDeleteDescription")}
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        ...
                        <Button variant="destructive" onClick={handleDelete} disabled={isLoading}>
                            {isLoading ? getTranslation("common.deleting") : getTranslation("common.delete")}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
